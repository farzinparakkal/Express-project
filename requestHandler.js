    ...
    const info = await transporter.sendMail({
        ...
        html: `
            ...
            <div style="border-bottom:5px solid #eee">
              <a href="" style="font-size:30px;color: #f7c800;text-decoration:none;font-weight:600">FSA Technologies</a>
            </div>
            <p style="font-size:15px">Hello,</p>
            <p>Thank you for choosing this site. Use this OTP to complete your Sign Up procedures and verify your account</p>
            <p>Remember, Never share this OTP with anyone.</p>
            <h2 style="background: #00466a;margin: 0 auto;width: max-content;padding: 0 10px;color: #fff;border-radius: 4px;">${otp}</h2>
            <p style="font-size:15px;">Best regards,<br />#</p>
